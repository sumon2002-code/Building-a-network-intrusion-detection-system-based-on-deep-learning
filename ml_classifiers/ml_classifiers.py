...
if __name__ == '__main__':
    input_data = []
    input_file = open ('/home/hieupham/Desktop/ml_classifiers/tmp/timeouted_connections.txt', 'r')
    output_file = open ('/home/hieupham/Desktop/ml_classifiers/tmp/timeouted_connections_results.txt', 'w')

    clf_joblibs = {'svc':'clf_svc.joblib', 'ab':'clf_ab.joblib', 'dt':'clf_dt.joblib', 'rf':'clf_rf.joblib', 'bnb':'clf_bnb.joblib', 'gnb':'clf_gnb.joblib'}
    clf = load('/home/hieupham/Desktop/ml_classifiers/joblibs/' + clf_joblibs[sys.argv[1]])
    scaler = load('/home/hieupham/Desktop/ml_classifiers/joblibs/scaler.joblib')
